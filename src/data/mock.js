...
export const MOCK_RESTAURANTS = [
  { id: 1, name: 'Pizza Palace', cuisine: 'Italian', rating: 4.5, deliveryTime: '25-35 min', ownerId: 2, isOpen: true, image: 'Pizza', latitude: 27.7150, longitude: 85.3120 },
  { id: 2, name: 'Burger Barn', cuisine: 'American', rating: 4.2, deliveryTime: '20-30 min', ownerId: null, isOpen: true, image: 'Burger', latitude: 27.7040, longitude: 85.3070 },
  { id: 3, name: 'Sushi Spot', cuisine: 'Japanese', rating: 4.7, deliveryTime: '30-40 min', ownerId: null, isOpen: true, image: 'Sushi', latitude: 27.6710, longitude: 85.3260 },
  { id: 4, name: 'Taco Town', cuisine: 'Mexican', rating: 4.3, deliveryTime: '15-25 min', ownerId: null, isOpen: false, image: 'Taco', latitude: 27.7210, longitude: 85.3620 },
  { id: 5, name: 'Curry House', cuisine: 'Indian', rating: 4.6, deliveryTime: '25-35 min', ownerId: null, isOpen: true, image: 'Curry', latitude: 27.7100, longitude: 85.3480 },
  { id: 6, name: 'Noodle Nest', cuisine: 'Chinese', rating: 4.1, deliveryTime: '20-30 min', ownerId: null, isOpen: true, image: 'Noodle', latitude: 27.6720, longitude: 85.4280 },
]
